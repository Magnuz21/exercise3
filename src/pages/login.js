                   ...
                   <div className="absolute inset-1 bg-gray-800 rounded-lg z-10 p-5">
                    <form onSubmit={handleSubmit()}>
                        ...
                        <div className="relative flex flex-col mb-12">
                            ...
                            <i className="bg-lime-500 rounded w-full bottom-0 left-0 absolute h-10 -z-10 duration-500 origin-bottom transform peer-focus: h-10
                            ...
                            left-0 -z-10 origin-[10] peer-focus-left-0 peer-focus:text-lime-500 text-lime-500-peer-placeholder-shown:
                        ...
                        <button type="submit"className="py-3 text-gray-100 bg-lime-500 w-full rounded hover:bg-lime-600
